...
export default function PricingSection() {
  return (
    <section
      id="pricing"
      className="w-full bg-[#191919] text-white py-24 sm:py-32"
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[850px] mx-auto">
          {/* Starter Card */}
          <div className="bg-[#212121] rounded-[20px] p-8 md:p-10 flex flex-col relative border-2 border-[#4ade80]/[0.25] hover:border-[#4ade80] transition-colors duration-500 ease-in-out">
            ...
            <div className="flex items-end gap-2 mb-8">
              <span className="text-[40px] leading-none font-serif font-normal text-white">
                $39
              </span>
              <span className="text-[15px] text-white/40 mb-1">/ month</span>
            </div>
            <button className="w-full py-3.5 rounded-full border-2 border-[#4ade80] text-sm font-medium text-white hover:bg-[#1A3D2B] hover:text-white hover:border-[#1A3D2B] transition-colors duration-300 mb-8">
              Get Started
            </button>
        ...
        <div className="mt-6 max-w-[850px] mx-auto relative overflow-hidden bg-[#1A3D2B] border border-[#4ade80]/20 rounded-[20px] px-6 py-12 md:py-14 text-center flex flex-col items-center justify-center">
          ...
          <h3 className="relative z-10 text-2xl font-serif font-normal mb-3 text-white">
            Professional
          </h3>
