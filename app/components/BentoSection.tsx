      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-0 w-full">
        ...
        >
          ...
          <div className="col-span-7 row-start-1 bg-[#F0EBE0] rounded-3xl p-10 flex flex-col justify-between overflow-hidden relative">
            {/* Decorative blobs */}
            <div className="absolute -top-10 -right-10 w-48 h-48 rounded-full bg-[#d6ccbd]/60 pointer-events-none" />
            <div className="absolute bottom-8 right-16 w-32 h-32 rounded-full bg-[#e2d9cc]/80 pointer-events-none" />
          ...
          {/* ── CARD B — Connected visual (col 8-12, row 1) ──────────────── */}
          <div className="col-span-5 row-start-1 bg-[#1A3D2B] rounded-3xl p-10 flex flex-col justify-between overflow-hidden relative">
            {/* Decorative ring */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full border border-white/[0.08] pointer-events-none" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-52 h-52 rounded-full border border-white/[0.06] pointer-events-none" />
            ...
            {/* Central handshake / connection visual */}
          ...
          <div className="col-span-3 row-start-2 flex flex-col gap-3">
            ...
            {/* D-2 : Chat conversation (dark green) */}
          ...
          <div className="col-span-5 row-start-2 bg-[#F0EBE0] rounded-3xl p-10 flex flex-col justify-between overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-end gap-6 sm:gap-10">
              ...
              <div className="flex items-end gap-3">
                {[
                  { initials: "SC", bg: "#191919", text: "#fff" },
                  { initials: "MR", bg: "#C41C26", text: "#fff" },
                  { initials: "AT", bg: "#1A3D2B", text: "#fff" },
                  { initials: "LK", bg: "#191919", text: "#fff" },
                ].map((a) => (
                  <div
                    key={a.initials}
                    className="w-12 h-12 rounded-full flex items-center justify-center text-sm font-medium border-2 border-[#F0EBE0] -ml-3 first:ml-0"
